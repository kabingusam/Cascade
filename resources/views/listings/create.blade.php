<x-layout>
    <x-card class="p-10 rounded max-w-lg mx-auto mt-24">
        <header class="text-center">
            ...
            <p class="mb-4">Post a Project/gig to find a developer</p>
        </header>
        ...
        <form method="POST" action="/listings" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label for="title" class="inline-block text-lg mb-2">Project/Job Title</label>
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full text-blue-500" name="location"
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full text-blue-500" name="email"
                    value="{{old('email')}}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full text-blue-500" name="website"
                    value="{{old('website')}}" />
